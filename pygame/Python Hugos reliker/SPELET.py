...
class GameState():
    ...
    def Titlecard(self):
        ...
        rect = pygame.rect((Screen_Widht//2, Screen_Height//2-50), 400, 400, 5)
        ...
        pygame.draw.rect(screen, (255, 255, 255), pygame.Rect(Screen_Widht//2, Screen_Height/2+50, 500, 75), 5)
